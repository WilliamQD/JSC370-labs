...
_Answer here._ There are a total of 192,700 sars-cov-2 papers.
...
institution <- stringr::str_extract_all(
  publications_txt,
  "University\\sof\\s[[:alnum:]]+ | [A-Z][[:alnum:]]*\\sInstitute\\sof\\s[[:alnum:]]+"
  ) 
...
schools_and_deps <- stringr::str_extract_all(
  publications_txt,
  "(School|Department)\\sof\\s[A-Z]+[a-z]*"
  )
...
_Answer here._ We found that 53 out of 338 publications don't have an Abstract section.
...
_Answer here._ None of the publications don't have a title.
